    ...
    <>
        ...
        <div className="my-auto font-light flex flex-row">
          {user?(
            <Dropdown label={user?user.name:''} className='bg-white' inline={true}>
              {(user && user.role=='admin')?(<Dropdown.Item onClick={()=>navigate('/dashboard')}>
              Dashboard
            </Dropdown.Item>):(<></>)}
      ...
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity text-white" >
          </div>
        </Transition.Child>
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-bgcolor shadow-xl text-white p-4">
                      <div className='border-b-2 border-gray-500 flex flex-row justify-between'>
                      ...
                      {cart.map((item)=>{
                        ...
                        return(
                          ...
                          className='p-8 w-32 h-32 rounded-full'
                          alt="" />
